...
class RasterDS(object):
    ...
    ## masked_subset not working because it depends on rasterstats. Nead to redo with rasterio or something
    ...
    ## need to resolve geometry_subset issue to make this work again.
