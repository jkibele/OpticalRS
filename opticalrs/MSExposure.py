...
def multi_apply_rank_filter(img, func, **kwargs):
    """
    The filter.rank methods take a mask. This will just apply them to a masked
    array.
...
def equalize_adapthist(img, **kwargs):
    """
    Given an image of shape RxCxBands, histogram adaptive histogram equalization to each band and reassemble into same
    shape and return.
